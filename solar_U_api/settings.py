"""
Django settings for solar_U_api project.
...
SECRET_KEY = 'django-insecure-*v!xqrq$ig%0-+zgsb1$+17v%=0!21v&#6*z34j-ev-jdijzuh'
...
WSGI_APPLICATION = 'solar_U_api.wsgi.application'
